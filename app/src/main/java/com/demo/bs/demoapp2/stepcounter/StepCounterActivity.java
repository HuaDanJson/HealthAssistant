...
//	private String[] tips={"Eat three meals a day，and the important one is dinner."
//			,"Choose lean meats, poultry, fish, beans, eggs, and nuts."
//			,"Control portion sizes. ; only eat the smallest portion that can satisfy hunger."
...
//			,"Avoid eating raw or undercooked meats of any type."};
	...
	protected void onDestroy() {
		// TODO Auto-generated method stub
//		Step step =new Step();
//		step.setStep(total_step+"");
//		step.setAccount(GlobalValue.getUserInfo().getUsername());
//		step.save(this, new SaveListener() {
//			@Override
...
//		});
	...
	private void addView() {
		...
		//tv_msg.setText(tips[randomValue(0,tips.length-1)]);
...
//    public static int randomValue(int startparam,int endparam) {
//        return ( startparam+(int)(Math.random() * endparam));
//    }
