...
//    };
    ...
    private void initNotify() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(String.valueOf(NOTIFY_ID), getResources().getString(com.pedometerlibrary.R.string.app_name), NotificationManager.IMPORTANCE_DEFAULT);
